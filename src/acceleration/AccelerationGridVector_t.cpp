...
AccelerationGridVector_t::AccelerationGridVector_t(Shape_t** items, unsigned int n_items, const Vec3f* coordinates/* = nullptr*/, unsigned int level /* = 0*/, unsigned int min_res /* = 1 */, unsigned int max_res /* = 128 */) : 
...
Shape_t* AccelerationGridVector_t::intersect(const Ray_t &ray, double &t, double (&uv)[2]) const {
    double tbbox;
