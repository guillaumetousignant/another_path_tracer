...
AccelerationGridArray_t::AccelerationGridArray_t(Shape_t** items, size_t n_items, unsigned int min_res, unsigned int max_res) : 
...
AccelerationGridArray_t::AccelerationGridArray_t(Shape_t** items, size_t n_items, std::array<Vec3f, 2> coordinates, unsigned int level, unsigned int min_res, unsigned int max_res) : 
