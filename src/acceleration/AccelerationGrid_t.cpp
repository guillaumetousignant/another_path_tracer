...
AccelerationGrid_t::AccelerationGrid_t(const std::vector<Shape_t*>& items, size_t min_res, size_t max_res) : level_(0), min_res_(min_res), max_res_(max_res), size_(items.size()) {
