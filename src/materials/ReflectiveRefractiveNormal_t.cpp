...
APTracer::Materials::ReflectiveRefractiveNormal_t::~ReflectiveRefractiveNormal_t() = default;

void APTracer::Materials::ReflectiveRefractiveNormal_t::bounce(const std::array<double, 2> &uv, const APTracer::Entities::Shape_t* hit_obj, APTracer::Entities::Ray_t &ray) {
    Vec3f tangent;
    Vec3f bitangent;
