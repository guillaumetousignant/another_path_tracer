...
APTracer::Materials::ScattererExp_t::ScattererExp_t(
    Vec3f emi_vol, Vec3f col_vol, double abs_dist_emi, double abs_dist_col, double scat_dist, double order, double scattering_angle, double ind, unsigned int priority) :
...
auto APTracer::Materials::ScattererExp_t::scatter(APTracer::Entities::Ray_t& ray) -> bool {
