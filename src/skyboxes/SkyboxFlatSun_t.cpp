...
APTracer::Skyboxes::SkyboxFlatSun_t::SkyboxFlatSun_t(const Vec3f &background, APTracer::Entities::DirectionalLight_t** lights, size_t n_lights) : background_(background), n_lights_(n_lights), lights_(n_lights_) {
