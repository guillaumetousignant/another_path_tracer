#ifndef APTRACER_MATERIALS_REFLECTIVEFUZZTEXNORMAL_T_HPP
#define APTRACER_MATERIALS_REFLECTIVEFUZZTEXNORMAL_T_HPP
...
namespace APTracer { namespace Materials {
    ...
    /**
     * @brief The reflective fuzz textured normal class describes a material that reflects rays at the same angle around the randomly disturbed surface normal taken from a normal map, to model glossy
     * reflection. Its reflective colour is taken from a texture.
     *
     ...
     * painted patterned brushed metals, sculpted frosted stained mirrors, and rough shiny shaped coloured plastic.
     */
    class ReflectiveFuzzTexNormal_t final : public Entities::Material_t {
        public:
            /**
             * @brief Construct a new ReflectiveFuzzTexNormal_t object with an emissive colour, a reflective texture, a normal map, the order of the curve describing the distribution of the surface
             * normal, and a diffusivity factor.
             *
             ...
             */
            ReflectiveFuzzTexNormal_t(const Entities::Vec3f& emission, Entities::Texture_t* texture, const Entities::Texture_t* normal_map, double order, double diffusivity);
