#ifndef APTRACER_MATERIALS_TEXTUREMIX_T_HPP
#define APTRACER_MATERIALS_TEXTUREMIX_T_HPP
...
namespace APTracer { namespace Materials {
    ...
    /**
     * @brief The texture mix material describes a mix of two materials, with the material being chosen randomly on bounce according to a ratio taken from a texture.
     *
