#ifndef APTRACER_MATERIALS_TEXTUREMIXIN_T_H
#define APTRACER_MATERIALS_TEXTUREMIXIN_T_H
...
namespace APTracer { namespace Materials {
    ...
    /**
     * @brief The texture mix in material describes a mix of two materials, with the material being chosen randomly on bounce according to a ratio taken from a texture on entrance, and the refracted material on material exit.
     * 
