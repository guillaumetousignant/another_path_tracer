#ifndef APTRACER_MATERIALS_DIFFUSETEXNORMAL_T_HPP
#define APTRACER_MATERIALS_DIFFUSETEXNORMAL_T_HPP
...
namespace APTracer { namespace Materials {
    ...
    /**
     * @brief The diffuse tex normal class describes a material that reflects rays in random directions around the surface normal taken from a normal map, to model diffuse reflection. Its reflective
