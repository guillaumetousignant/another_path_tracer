#ifndef APTRACER_MATERIALS_REFLECTIVEREFRACTIVEFUZZ_T_H
#define APTRACER_MATERIALS_REFLECTIVEREFRACTIVEFUZZ_T_H
...
namespace APTracer { namespace Materials {
    ...
    class ReflectiveRefractiveFuzz_t final : public Material_t {
        public:
            /**
             * @brief Construct a new ReflectiveRefractiveFuzz_t object with an emissive and reflective colour, a medium, the order of the curve describing the distribution of the surface normal, and a diffusivity factor.
             * 
