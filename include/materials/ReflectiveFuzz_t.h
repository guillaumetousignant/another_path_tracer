#ifndef APTRACER_MATERIALS_REFLECTIVEFUZZ_T_H
#define APTRACER_MATERIALS_REFLECTIVEFUZZ_T_H
...
namespace APTracer { namespace Materials {
     ...
     * frosted mirors, and rough shiny plastic.
     */
    class ReflectiveFuzz_t final : public Material_t {
        public:
            /**
             * @brief Construct a new ReflectiveFuzz_t object with an emissive and reflective colour, the order of the curve describing the distribution of the surface normal, and a diffusivity factor.
             * 
