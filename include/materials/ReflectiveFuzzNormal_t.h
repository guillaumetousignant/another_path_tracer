#ifndef APTRACER_MATERIALS_REFLECTIVEFUZZNORMAL_T_H
#define APTRACER_MATERIALS_REFLECTIVEFUZZNORMAL_T_H
...
namespace APTracer { namespace Materials {
    ...
    /**
     * @brief The reflective fuzz normal class describes a material that reflects rays at the same angle around the randomly disturbed surface normal taken from a normal map, to model glossy reflection.
     * 
     ...
     * sculpted frosted mirors, and rough shiny shaped plastic.
     */
    class ReflectiveFuzzNormal_t final : public Material_t {
        public:
            /**
             * @brief Construct a new ReflectiveFuzzNormal_t object with an emissive and reflective colour, a normal map, the order of the curve describing the distribution of the surface normal, and a diffusivity factor.
             * 
