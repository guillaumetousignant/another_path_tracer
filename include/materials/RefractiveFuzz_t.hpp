...
namespace APTracer { namespace Materials {
     ...
     */
    class RefractiveFuzz_t final : public Entities::Material_t {
        public:
            /**
             ...
             */
            RefractiveFuzz_t(const Entities::Vec3f& emission, const Entities::Vec3f& colour, double order, double diffusivity, Entities::Medium_t* medium);
