#ifndef APTRACER_MATERIALS_SCATTERERFULL_T_H
#define APTRACER_MATERIALS_SCATTERERFULL_T_H
...
namespace APTracer { namespace Materials {
    ...
    class ScattererFull_t final : public Medium_t {
        public:
            /**
             * @brief Construct a new ScattererFull_t object with a volumetric colour and emissive colour, a scattering colour and emissive colour, the volumetric absorption/emission distance, and a scattering distance.
             * 
