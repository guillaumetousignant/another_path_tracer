#ifndef APTRACER_MATERIALS_REFLECTIVEFUZZTEX_T_H
#define APTRACER_MATERIALS_REFLECTIVEFUZZTEX_T_H
...
namespace APTracer { namespace Materials {
    ...
    /**
     * @brief The reflective fuzz textured class describes a material that reflects rays at the same angle around the randomly disturbed surface normal, to model glossy reflection. Its reflective colour is taken from a texture.
     * 
    ...
    class ReflectiveFuzzTex_t final : public Material_t {
        public:
            /**
             * @brief Construct a new ReflectiveFuzzTex_t object with an emissive colour, a reflective texture, the order of the curve describing the distribution of the surface normal, and a diffusivity factor.
             * 
             ...
             */
            ReflectiveFuzzTex_t(const Vec3f &emission, Texture_t* texture, double order, double diffusivity);
