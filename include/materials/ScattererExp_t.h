...
namespace APTracer { namespace Materials {
     ...
     */
    class ScattererExp_t final : public Medium_t {
        public:
            /**
             * @brief Construct a new ScattererExp_t object with a colour, emissive colour, and their respective absorption/emission distance, a scattering distance, the order of the curve describing the distribution of the scattering angle, and a scattering angle.
             * 
             ...
             */
            ScattererExp_t(Vec3f emi_vol, Vec3f col_vol, double abs_dist_emi, double abs_dist_col, double scat_dist, double order, double scattering_angle, double ind, unsigned int priority);
