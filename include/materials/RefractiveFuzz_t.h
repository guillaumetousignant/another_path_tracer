#ifndef APTRACER_MATERIALS_REFRACTIVEFUZZ_T_H
#define APTRACER_MATERIALS_REFRACTIVEFUZZ_T_H
...
namespace APTracer { namespace Materials {
    ...
    class RefractiveFuzz_t final : public Material_t {
        public:
            /**
             * @brief Construct a new RefractiveFuzz_t object with an emissive and reflective colour, a medium, the order of the curve describing the distribution of the surface normal, and a diffusivity factor.
             * 
