#ifndef APTRACER_MATERIALS_SCATTERER_T_HPP
#define APTRACER_MATERIALS_SCATTERER_T_HPP
...
namespace APTracer { namespace Materials {
     ...
     */
    class Scatterer_t final : public Entities::Medium_t {
        public:
            /**
             ...
             */
            Scatterer_t(Entities::Vec3f emi_vol, Entities::Vec3f col_vol, double abs_dist_emi, double abs_dist_col, double scat_dist, double ind, unsigned int priority);
