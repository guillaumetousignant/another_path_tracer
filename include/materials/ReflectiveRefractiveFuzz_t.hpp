#ifndef APTRACER_MATERIALS_REFLECTIVEREFRACTIVEFUZZ_T_HPP
#define APTRACER_MATERIALS_REFLECTIVEREFRACTIVEFUZZ_T_HPP
...
namespace APTracer { namespace Materials {
    ...
    /**
     * @brief The reflective refractive class describes a material that reflects and refracts rays around the randomly disturbed surface normal, to model refractive surfaces.
     *
     ...
     */
    class ReflectiveRefractiveFuzz_t final : public Entities::Material_t {
        public:
            /**
             * @brief Construct a new ReflectiveRefractiveFuzz_t object with an emissive and reflective colour, a medium, the order of the curve describing the distribution of the surface normal, and
             ...
             */
            ReflectiveRefractiveFuzz_t(const Entities::Vec3f& emission, const Entities::Vec3f& colour, double order, double diffusivity, Entities::Medium_t* medium);
