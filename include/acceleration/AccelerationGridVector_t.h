...
namespace APTracer { namespace Acceleration {
    ...
    class AccelerationGridVector_t final : public AccelerationStructure_t {
        public:
            ...
            std::vector<std::unique_ptr<GridCellVector_t>> cells_; /**< @brief Array of all the cells contained in the acceleration structure. Cells use vectors of shapes, for fast iterating and low memory use.*/
