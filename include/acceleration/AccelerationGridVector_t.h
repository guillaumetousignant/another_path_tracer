...
namespace APTracer { namespace Acceleration {
    ...
    class AccelerationGridVector_t final : public AccelerationStructure_t {
        public:
             ...
             */
            AccelerationGridVector_t(const std::vector<Shape_t*>& items, size_t min_res, size_t max_res);
             ...
             * @param max_res Maximum number of cells for all directions.
             */
            AccelerationGridVector_t(const std::vector<Shape_t*>& items, std::array<Vec3f, 2> coordinates, unsigned int level, size_t min_res, size_t max_res);
