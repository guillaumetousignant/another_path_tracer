#ifndef APTRACER_ACCELERATIONMULTIGRID_T_HPP
#define APTRACER_ACCELERATIONMULTIGRID_T_HPP
...
namespace APTracer { namespace Acceleration {
    ...
    /**
     * @brief The acceleration multi grid class describes a multi-level grid acceleration structure, splitting the space into uniform cells or grids, depending on the number of shapes in a cell. Cells
     * use lists of shapes, for constant time adding and removal of shapes.
     *
     ...
     * maximum grid recursion level. This structure with its list representation is more geared toward moving scenes, as the cost to remove, add or move shapes from one cell to another is lower.
     */
    class AccelerationMultiGrid_t final : public Entities::AccelerationStructure_t {
        public:
            /**
             ...
             */
            AccelerationMultiGrid_t(const std::vector<Entities::Shape_t*>& items, size_t min_res, size_t max_res, size_t max_cell_content, unsigned int max_grid_level);

            /**
             * @brief Construct a new AccelerationMultiGrid_t object from an array of shapes.
             *
             * @param items Array of shapes to be added to the acceleration structure.
             ...
             * @param max_grid_level Maximum recursion level of the grid. 0 is no subgrids, 1 means cells from the top-level grid can be single level grids, etc.
             */
            AccelerationMultiGrid_t(const std::vector<Entities::Shape_t*>& items,
            ...
            /**
             * @brief Destroy the AccelerationMultiGrid_t object.
             */
            ~AccelerationMultiGrid_t() final = default;

            /**
             * @brief Copy construct a new AccelerationMultiGrid_t object.
             *
             * @param other Object to copy.
             */
            AccelerationMultiGrid_t(const AccelerationMultiGrid_t& other);

            /**
             * @brief Move construct a new AccelerationMultiGrid_t object.
             *
             * @param other Object to move.
             */
            AccelerationMultiGrid_t(AccelerationMultiGrid_t&& other) noexcept = default;

            /**
             * @brief Copy assignment.
             *
             * @param other Object to copy.
             * @return AccelerationMultiGrid_t& Reference to this object.
             */
            auto operator=(const AccelerationMultiGrid_t& other) -> AccelerationMultiGrid_t&;
             ...
             * @return AccelerationMultiGrid_t& Reference to this object.
             */
            auto operator=(AccelerationMultiGrid_t&& other) noexcept -> AccelerationMultiGrid_t& = default;

            std::vector<std::unique_ptr<AccelerationStructure_t>>
                cells_; /**< @brief Array of all the cells and grids contained in the acceleration structure. Cells use lists of shapes, for constant time adding and removal of shapes.*/
