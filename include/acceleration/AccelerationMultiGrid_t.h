...
namespace APTracer { namespace Acceleration {
    ...
    class AccelerationMultiGrid_t final : public AccelerationStructure_t{
        public:
             ...
             */
            AccelerationMultiGrid_t(Shape_t** items, size_t n_items, const Vec3f* coordinates = nullptr, unsigned int level = 0, unsigned int min_res = 1, unsigned int max_res = 128, unsigned int max_cell_content = 32, unsigned int max_grid_level = 1);
