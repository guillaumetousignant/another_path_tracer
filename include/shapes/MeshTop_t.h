#ifndef APTRACER_SHAPES_MESHTOP_T_H
#define APTRACER_SHAPES_MESHTOP_T_H
...
namespace APTracer { namespace Shapes {
    ...
    class MeshTop_t {
        public:
            ...
            std::vector<std::unique_ptr<Shape_t>> triangles_; /**< @brief Array of triangles held by the mesh.*/
