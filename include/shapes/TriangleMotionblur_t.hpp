#ifndef APTRACER_SHAPES_TRIANGLEMOTIONBLUR_T_HPP
#define APTRACER_SHAPES_TRIANGLEMOTIONBLUR_T_HPP
...
namespace APTracer { namespace Shapes {
     ...
     */
    class TriangleMotionblur_t final : public Entities::Shape_t {
        public:
            /**
             ...
             */
            TriangleMotionblur_t(Entities::Material_t* material,
                                 Entities::TransformMatrix_t* transform_matrix,
                                 std::array<Entities::Vec3f, 3> points,
                                 std::array<Entities::Vec3f, 3> normals,
                                 std::array<double, 6> texcoord);

            std::array<Entities::Vec3f, 3>
