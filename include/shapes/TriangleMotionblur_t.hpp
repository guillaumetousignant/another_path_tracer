...
namespace APTracer { namespace Shapes {
    ...
    class TriangleMotionblur_t final : public Shape_t {
        public:
             ...
             */
            TriangleMotionblur_t(Material_t* material, TransformMatrix_t* transform_matrix, std::array<Vec3f, 3> points, std::array<Vec3f, 3> normals, std::array<double, 6> texcoord);
