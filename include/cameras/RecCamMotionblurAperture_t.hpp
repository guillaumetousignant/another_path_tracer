#ifndef APTRACER_CAMERAS_RECCAMMOTIONBLURAPERTURE_T_HPP
#define APTRACER_CAMERAS_RECCAMMOTIONBLURAPERTURE_T_HPP
...
namespace APTracer { namespace Cameras {
    ...
    class RecCamMotionblurAperture_t final : public Entities::Camera_t {
        public:
             ...
             */
            RecCamMotionblurAperture_t(Entities::TransformMatrix_t* transformation,
