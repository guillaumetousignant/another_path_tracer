#ifndef APTRACER_CAMERAS_CAMMOTIONBLUR_T_HPP
#define APTRACER_CAMERAS_CAMMOTIONBLUR_T_HPP
...
namespace APTracer { namespace Cameras {
     ...
     * aperture.
     */
    class CamMotionblur_t final : public Entities::Camera_t {
        public:
            /**
             ...
             */
            CamMotionblur_t(Entities::TransformMatrix_t* transformation,
