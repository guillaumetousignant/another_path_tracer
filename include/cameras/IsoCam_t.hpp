#ifndef APTRACER_CAMERAS_ISOCAM_T_HPP
#define APTRACER_CAMERAS_ISOCAM_T_HPP
...
namespace APTracer { namespace Cameras {
     ...
     */
    class IsoCam_t final : public Entities::Camera_t {
        public:
            /**
             ...
             */
            IsoCam_t(Entities::TransformMatrix_t* transformation,
