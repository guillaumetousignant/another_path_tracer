#ifndef APTRACER_CAMERAS_FISHCAM_T_HPP
#define APTRACER_CAMERAS_FISHCAM_T_HPP
...
namespace APTracer { namespace Cameras {
     ...
     */
    class FishCam_t final : public Entities::Camera_t {
        public:
            /**
             ...
             */
            FishCam_t(Entities::TransformMatrix_t* transformation,
