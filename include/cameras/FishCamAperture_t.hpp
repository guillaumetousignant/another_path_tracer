#ifndef APTRACER_CAMERAS_FISHCAMAPERTURE_T_HPP
#define APTRACER_CAMERAS_FISHCAMAPERTURE_T_HPP
...
namespace APTracer { namespace Cameras {
     ...
     * motion blur.
     */
    class FishCamAperture_t final : public Entities::Camera_t {
        public:
            /**
             ...
             */
            FishCamAperture_t(Entities::TransformMatrix_t* transformation,
