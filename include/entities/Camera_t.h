#ifndef APTRACER_ENTITIES_CAMERA_T_H
#define APTRACER_ENTITIES_CAMERA_T_H
...
namespace APTracer { namespace Entities {
    ...
    class Camera_t {
        public:
             ...
             */
            Camera_t(TransformMatrix_t* transformation,
                     std::string filename,
                     Vec3f up,
            ...
            std::list<Medium_t*> medium_list_; /**< @brief List of materials in which the camera is placed. Active medium is first element. Should have at least two copies of an "outside" medium not
                                                  assigned to any object (issue #25).*/
             ...
             *
             * The camera will generate rays according to its projection, and cast them through the provided scene. The resulting colour can be written to an image buffer. This will generate one
             * image.
             *
