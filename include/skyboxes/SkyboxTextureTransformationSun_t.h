#ifndef APTRACER_SKYBOXTEXTURETRANSFORMATIONSUN_T_H
#define APTRACER_SKYBOXTEXTURETRANSFORMATIONSUN_T_H
...
namespace APTracer { namespace Skyboxes {
    ...
    class SkyboxTextureTransformationSun_t final : public Skybox_t{
        public:
            ...
            double sun_pos_[2]; /**< @brief TPosition of the light source in normalized coordinates on the image, [x, y] both from 0 to 1, from bottom left corner.*/
